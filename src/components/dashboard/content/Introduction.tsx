    ...
    return(
        <div className="introduction">
            <div className="section-item">
                ...
                <p>For the sole purpose of trying to be more productive, I created a personalized dashboard web app. The dashboard serves 3 main functionalities. First, it serves as a task manager (To-Do List) to keep track of my scheduling. Second, through web scraping, it compiles a collection of software developing related job postings from multiple sources. Third, it keeps track of the prices and news updates of any stocks of interest.</p>
                ...
                <p>The client-side application is built on React using the create-react-app command. For all dependencies, refer to the <span><a className="inline-link" href="https://github.com/ikim1991/my-dashboard-app/blob/master/package.json/" target="_blank" rel="noreferrer">package.json</a></span> file.</p>
                <p>The server-side application is built on Nodejs using Express. It uses MongoDB as a database service. The server uses REST APIs to communicate with the clients. For all dependencies, refer to the <span><a className="inline-link" href="https://github.com/ikim1991/my-dashboard-app-api/blob/master/package.json/" target="_blank" rel="noreferrer">package.json</a></span> file.</p>
