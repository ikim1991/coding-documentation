    ...
    return(
        <div className="introduction">
            <div className="section-item">
                ...
                <div className="repo">
                    <p><a className="repo" href="https://google.ca" target="_blank" rel="noreferrer">The Front-End</a></p>
                    <p><a className="repo" href="https://google.ca" target="_blank" rel="noreferrer">The Back-End</a></p>
                </div>
