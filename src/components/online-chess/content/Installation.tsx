    ...
    return(
        <div className="installation">
            <div className="section-item">
                ...
                <p>To play this game online or see the production version, check it out at the <span><a className="inline-link" href="https://google.ca" target="_blank" rel="noreferrer">LINK HERE</a></span></p>
            ...
            <div className="section-item">
                ...
                <p>The client side is built on the React Library and bundled using Webpack. To introduce environment variables, they must be injected using plugins. This can be done in the <span><a className="inline-link" href="https://google.ca" target="_blank" rel="noreferrer">webpack.config.js</a></span> file.</p>
