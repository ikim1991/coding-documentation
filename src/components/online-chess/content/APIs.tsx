        ...
        <div className="apis">
            ...
            <div className="section-item">
                ...
                <div className="indent">
                    ...
                    <p>The Game Collection Schema consists of the unique identifier generated by the Client, user host, user joiner, and the state of the game. The host and joiner are a subdocument of Player.</p>
                ...
                <div className="indent">
                    ...
                    <p>The Chessboard Collection Schema consists of the unique identifier generated by the Client, a list of columns and rows to create a chessboard using Cartesian coordinates, a list of occupied squares in the chessboard by which chesspieces, a subdocument of chesspieces, a subdocument of a list of players, whether the game is at a checkmate, and whether the game should reset.</p>
